# serve.ps1 - Start NeuraPress frontend + admin API cleanly.
# Usage:  powershell -ExecutionPolicy Bypass -File scripts\serve.ps1

$ErrorActionPreference = "SilentlyContinue"
$root = Split-Path $PSScriptRoot -Parent
$web  = Join-Path $root "NeuraPress\web"
...
Push-Location $root
Start-Process -FilePath $py -ArgumentList @("-m", "uvicorn", "NeuraPress.api.app:app", "--port", "8001") -WindowStyle Minimized
Pop-Location
