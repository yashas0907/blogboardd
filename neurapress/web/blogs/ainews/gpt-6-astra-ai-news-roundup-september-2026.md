...
OpenAI announced **GPT-6 Astra**, positioning it as the first LLM that can *open a spreadsheet, write a macro, and run it safely* in a single conversational turn. The company says Astra tops the latest benchmark suites—**FrontierMath Tier 4**, **ARC-AGI-3**, and **TerminalBench-4.0**—and can solve “100 % of public security-evaluation benchmarks,” a metric OpenAI dubs the **Critical Cybersecurity Threshold**.
...
> “For the first time, a language model can **open a spreadsheet, write a macro, and run it safely**, all in a single conversational turn.” – *Fortune*  

---

## 2. OpenAI’s “Cyber-Secure Access” Program – Managing Advanced Cyber Capabilities  

**Source:** *CNBC* – “OpenAI begins rolling out Astra model after warning of its advanced cyber capabilities”  

Recognizing the dual-use nature of Astra, OpenAI paired the launch with a **Astra Cyber-Secure Access** program. The initiative is designed to monitor and throttle any code-generation that could be misused.
...
> “Astra will be available first to companies that sign up for the **Astra Cyber-Secure Access** program, where OpenAI will monitor usage 24/7 and enforce strict throttling on code-generation that could be misused.” – *CNBC*  

> “OpenAI says the model can *solve 100 % of public security-evaluation benchmarks*, a capability it calls the *Critical Cybersecurity Threshold*.” – *CNBC*  
