...
- Avoid sensational security/hacking vocabulary (exploits, malware, weaponized, attack
  instructions) — describe such topics at a high, defensive level. Browsers flag pages
  containing attack vocabulary as dangerous sites.
"""
