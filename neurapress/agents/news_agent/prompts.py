...
- Write about security topics in a DEFENSIVE, journalistic tone: never include
  exploit-writing instructions, malware details, or attack how-tos. Describe
  capabilities at a high level (e.g. "advanced cyber capabilities") — browsers
  flag pages containing attack vocabulary as dangerous sites.
"""
