"""NeuraPress Admin API — health, stats, article listing, generation trigger."""
...
from neurapress.graph.graph import graph
from neurapress.services.storage import get_storage

app = FastAPI(
    title="NeuraPress Admin API",
    version="0.1.0",
    description="Inspect and trigger the NeuraPress multi-agent article pipeline.",
)
...
def generate(
    ...
    config = {"configurable": {"thread_id": "neurapress-api"}}
