...
def test_factory_returns_local_when_configured(tmp_path: Path, monkeypatch):
    ...
    import neurapress.config.settings as settings_mod

    importlib.reload(settings_mod)
    import neurapress.services.storage as storage_mod
...
def test_factory_rejects_unknown_backend(monkeypatch, tmp_path: Path):
    monkeypatch.setattr("neurapress.services.storage.app_settings.storage_backend", "ftp")
